    ...
    <body>
        <div class="terms-box">
            <div class="terms-text">
                ...
                <p>Our Terms of Service were last updated on 25/11/2022.</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Homify.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>"Website"</strong> refers to Homify, accessible from <a href="http://localhost/airbnb/owner/login.php">here</a> to navigate to our website.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="http://localhost/airbnb/owner/login.php">Here</a></li>
                    <li>By sending us an email: p21013168@student.newinti.edu.my</li>
                </ul>
                <p></p>
            </div>
