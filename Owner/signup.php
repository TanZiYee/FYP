...
<body class="form-v5" style = "background: linear-gradient(to right,#2F2F9C,#D6D6F2);" >
		...
		<div class="form-v5-content">
			...
			<form class="form-detail" action="" method="post">
				...
				<div class="form-row" >  
					...
					<input type="text" name="ownerName" id="ownerName" class="input-text" placeholder="Your Name" required pattern="^[A-Za-z][A-Za-z0-9]*[A-Za-z0-9]$" title="The username must start with an alphabet character (A-Z or a-z), followed by any combination of alphabet characters, numbers, and underscores, and it cannot end with an underscore.">                                       
				</div>
