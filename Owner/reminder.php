...
if (isset($_POST['pwdrst'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($res > 0) {
            $message = '<div>
             <p><b>Hello!</b></p>
             <p>You are receiving this email as a reminder that you are coming to make payment for your property renting.</p>
             <br>
             Click <a href="http://localhost/airbnb/login.php?secret=' . base64_encode($email) . '">here</a> to login in order to make changes.
             <br>
            ...
            $mail->Subject = "Noticed! It's time to make payment.";
            $mail->isHTML(true);
            $mail->Body = $message;
