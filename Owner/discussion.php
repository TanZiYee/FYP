        ...
        <div class="full-row">
			...
			<div class="col-lg-12">
				...
				<h5 class="text-secondary">Basic Information</h5><hr>
					...
					<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9">
                                                            <input type="text" class="form-control" name="ownername" required placeholder="Enter Name">
							</div>
				...
				<h5 class="text-secondary">Recent Post</h5><hr>
                                    <?php 
                                    include 'db.php';
                                    $qry = $con->query("SELECT * FROM discussion_owner");
					...
					<div class="card mb-4 border-0 shadow">
                                          <div class="row g-0 p-3 align-items-center">
                                            <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                                              ...
                                              <h6 class="mb-3 align-content-center"><?php echo $row['ownername']?></h6>
                                            </div>
