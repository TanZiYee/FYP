            ...
            <div class="container"><!-- FOR MORE PROJECTS visit: codeastro.com -->
				...
				<th class="text-white font-weight-bolder">Delete</th>
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							...
							$query=mysqli_query($con,"SELECT * FROM `property` WHERE ownerID='$ownerID'");
								while($row=mysqli_fetch_array($query))
								{
							?>
                            <tr>
                                <td>
                                    <img src="property/<?php echo $row['20'];?>" alt="pimage">
                                    <div class="property-info d-table">
                                        ...
                                        <div class="price mt-3">
                                            <span class="text-success">$&nbsp;<?php echo $row['15'];?></span>
					</div>
                                    </div>
				</td>
