    ...
    if (!filter_var($Email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($res > 0) {
            $message = '<div>
             ...
             <br>
             Click <a href="http://localhost/airbnb/Owner/passwordreset.php?secret=' . base64_encode($Email) . '">here</a> to reset your password.
             <br>
		...
		<div class="form-v5-content">
			...
			<form class="form-detail" id="validate_form" method="post">
				...
				<div class="form-row-last">
					<input type="submit" id="login" name="pwdrst" class="btn btn-success" value="Send Password Reset Link">
				</div>
