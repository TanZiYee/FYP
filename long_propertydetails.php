                    ...
                    <div class="card mb-4 border-0 shadow-sm rounded-3">
                        <div class="card-body">
                            ...
                            <?php while ($roomDetails = $roomResult->fetch_assoc()): ?>
                                <div>
                                    <h4>RM <?php echo $roomDetails['price']; ?> per month</h4>
                                    ...
                                    <div class="d-flex justify-content-evenly mb-2">
                                        <a href="long_confirm_booking.php?propertyID=<?php echo $roomDetails['propertyID']; ?>" class="btn btn-primary">Book Now</a>
                                    </div>
