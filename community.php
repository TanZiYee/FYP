...
<body  style = "background: linear-gradient(to right,#71c9ce , #eeeeee);"  >
  ...
  <?php
            ...
            if (!isset($_GET['id'])) {
                header("Location: community.php"); // Redirect to a different page if propertyID is missing
                exit;
            }
            ...
            $stmt->bind_param("i", $is); // Assuming 'propertyID' is an integer
            ...
            if ($result->num_rows == 0) {
                echo "No posts found for discussionID: $id"; // Display a message if no rooms are found
            } else {
					...
					<div class="card mb-4 border-0 shadow">
                                          <div class="row g-0 p-3 align-items-center">
                                            ...
                                            <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                                                <a href="edit_post.php?id=<?php echo $row['id']; ?>" class="btn btn-primary w-100 mb-2">Edit</a>
                                            </div>
                                          </div>
                                        </div>
                                    <?php } ?>						
