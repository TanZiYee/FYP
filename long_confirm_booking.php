                ...
                <div class="col-lg-7 col-md-12 px-4">
                           <?php
                            ...
                            <div class="card p-3 shadow-sm rounded">
                                ...
                                <h6>RM <?php echo $row['price']; ?> per month</h6>
                                <hr>
                                <alert>NOTE: The check-in and check-out date only put within ONE MONTH. This is only pay for deposit.</alert>
                            </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <a href="long_checkout.php?propertyID=<?php echo $row['propertyID']; ?>" class="btn btn-primary w-100 mb-1">Pay Now</a>
                                </div>
