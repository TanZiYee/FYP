        ...
        <div class="terms-box">
            <div class="terms-text">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>"Website"</strong> refers to Homify, accessible from <a href="http://localhost/airbnb/login.php">here</a> to navigate to our website.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="http://localhost/airbnb/login.php">Here</a></li>
