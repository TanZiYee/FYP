...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($con, "DELETE FROM `discussion_owner` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                 ...
                 <main>
                    ...
                    <br>
                    <h3 style="text-align:center">  <i class="fas fa-tasks"></i> Manage Owner Community Post</h3>
                    <br>
                         ...
                         <table>
                            ...
                            <tbody>
                               <?php
                                  ...
                                  $select_products = mysqli_query($con, "SELECT * FROM `discussion_owner`");
                               ...
                               <tr>
                                  ...
                                  <td>
                                     <a href="owner_CP.php?delete=<?php echo $row['id']; ?>" class="delete-btn"  onclick="return confirm('Are your sure you want to delete this?');"> <i class="fas fa-trash"></i> Delete </a>
                                  </td>
                               </tr>
