...
<html lang="en">
    ...
    <body  style = "background: linear-gradient(to right,#71c9ce , #eeeeee);"  >
        ...
        <div class="my-5 px-4">
            <h2 class="fw-bold h-font text-center">SHORT-TERM WISHLIST</h2>
                      ...
                      <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" style="font-size: 18px;">WISHLIST</h5>
                                <div class="mb-2">
                                    <a class="nav-link" href="short_wishlist.php">
                                        <div class="sb-nav-link-icon"><i class="fas fa-list"></i> Short-Term </div>
                                    </a>
                                    <a class="nav-link" href="long_wishlist.php">
                                        <div class="sb-nav-link-icon"><i class="fas fa-list"></i> Long-Term </div>
                                    </a>
                                </div>
                            </div>
                            <div class="border bg-light p-3 rounded mb-3">
