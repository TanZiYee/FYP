                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="Owner/property/<?php echo $row['pimage1'];?>" height="200" class="d-block w-100">
                          </div>
                          <div class="carousel-item">
                            <img src="Owner/property/<?php echo $row['pimage2'];?>" height="200" class="d-block w-100" >
                          </div>
                          <div class="carousel-item">
                            <img src="Owner/property/<?php echo $row['pimage3'];?>" height="200" class="d-block w-100" >
                          </div>
                          <div class="carousel-item">
                            <img src="Owner/property/<?php echo $row['pimage4'];?>" height="200" class="d-block w-100" >
                          </div>
                          <div class="carousel-item">
...
<!--                        <div class="facilities mb-4">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                            ...
                            <a href="propertydetails.php?propertyID=<?php echo $row['propertyID']; ?>" class="btn btn-sm btn-outline-dark">More Details</a>
                        </div>
                    </div>
    ...
    <div class="col-lg-12 text-center mt-5">
        <a href="property_short.php" class="btn btn-sm btn outline-dark rounded-0 fw-bold shadow-none">More Rooms >>></a>
    </div>
